...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nclass Search {\n  constructor(query) {\n    this.query = query;\n  }\n\n  async getResults() {\n    // const proxy = 'https://cors-anywhere.herokuapp.com/';\n    try {\n      const res = await axios__WEBPACK_IMPORTED_MODULE_0___default()(`//api.giphy.com/v1/gifs/search?q=${this.query}&api_key=zb0GF9tH99N0q22DA8jAP5vNA00kGCXk&limit=5`);\n      this.result = res.data.data; // console.log(this.result);\n    } catch (error) {\n      alert(error);\n    }\n  }\n\n}\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
